...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211001_landingp_1df0140d7ce96eef4790_20211001072037_archive.zip';
	const ARCHIVE_SIZE		 = '34314856';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '1df0140-01072037';
    const SECONDARY_PACKAGE_HASH = '09b4199-01072037';
	const VERSION			 = '1.4.3';
